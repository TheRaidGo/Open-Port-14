...
ent-TP14WaterTankEmergencyFilled = аварийный водный резервуар
    .suffix = Заполненный
    .desc = Резервуар, предназначенный для хранения небольшого количества воды. Этого хватит ненадолго.
ent-TP14WaterTankFilled = баллон с водой
    .suffix = Заполненный
    .desc = Прочный резервуар, предназначенный для хранения морской воды.
