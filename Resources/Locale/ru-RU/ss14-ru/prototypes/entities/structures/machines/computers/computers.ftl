...
ent-ComputerBell = пульт водолазного колокола
    .desc = Позволяет вам управлять водолазным колоколом.
ent-ComputerTrench = пульт управления траншейным колоколом
    .desc = Управляет колоколом для исследования траншей.
