...
ent-PosterContrabandDonutCorp = Корпорация "Пончик".
    .desc = Этот плакат является несанкционированной рекламой корпорации "Пончик".
...
ent-PosterContrabandPwrGame = Заряженная Игра
    .desc = СИЛА, которой ЖАЖДУТ геймеры! В партнёрстве с компанией 'Салат от Влада'.
ent-PosterContrabandSunkist = Солнце-кист
    .desc = Выпейте звёзд!
ent-PosterContrabandSpaceCola = Космическая Кола
    .desc = Твоя любимая кола, в космосе.
ent-PosterContrabandSpaceUp = Выше-космоса!
...
ent-PosterContrabandInterdyne = 'Интердайн Фармацевтикс': Во имя здоровья человечества
    .desc = Реклама генных клиник GeneClean корпорации 'Интердайн Фармацевтикс'. 'Станьте хозяином своего тела!'
ent-PosterContrabandWaffleCorp = Корпорация "Вафли": Отличные винтовки, доступные цены
    .desc = Старая реклама винтовок от корпорации "Вафли". 'Пушки лучше, цены ниже!'
