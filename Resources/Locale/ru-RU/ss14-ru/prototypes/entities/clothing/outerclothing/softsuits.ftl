...
ent-TP14ClothingOuterSuitCosplay = Изодранный в клочья комбинезон
    .desc = Странно подозрительный красный костюм. Похоже, что он был сшит из аварийного скафандра для выхода в открытый космос от скуки, как это часто бывает.
