...
ent-ClothingMaskBreathNeck = аппарат для адаптации легких
    .desc = Серия трубок, соединяющих резервуар с легкими пользователя. Обеспечивает более комфортное использование. После надевания, конечно.
