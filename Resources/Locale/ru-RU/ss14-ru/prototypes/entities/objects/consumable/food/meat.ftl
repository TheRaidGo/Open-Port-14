...
ent-TP14FoodMeatFish = сырое рыбное филе
    .desc = Вкусное сырое филе.
ent-FoodMeatFishCarp = сырое филе карпа
    .desc = Ваши последние слова "Ух ты, экзотика!" того не стоят. А сам вкус? Может быть.
