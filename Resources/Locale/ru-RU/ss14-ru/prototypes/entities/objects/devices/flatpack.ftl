...
ent-HotplateFlatpack = набор для факса
    .desc = Набор, используемый для изготовления конфорки.
ent-ReagentGrinderFlatpack = набор для измельчителя реагентов
    .desc = Набор для сборки измельчителя реагентов.
ent-CentrifugeFlatpack = набор центрифуги
    .desc = Набор для сборки центрифуги.
